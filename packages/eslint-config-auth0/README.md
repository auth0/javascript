...
If you use yarn, run `yarn add --dev eslint-config-auth0-base eslint-plugin-import eslint-plugin-react eslint-plugin-jsx-a11`, and see below for npm instructions.
